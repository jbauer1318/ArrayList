...
public class List_Client {
	...
	public static void main(String[] args){
		...
		UnorderedArrayList list2 = new UnorderedArrayList();
		UnorderedArrayList list3 = new UnorderedArrayList();
		
		if(fileOpened){
				while(file1.hasNext()) {
					if(file1.hasNextInt())
						list1.insertEnd(file1.nextInt());	
					else
						file1.next();
					}
